...
print("Hey asshat")
print("you need to save some effing money$$")
...
while userEntryExpense != 0: 
    userEntryExpense =float(input("asshat, enter what you spent: "))
    monthTotal= monthTotal - userEntryExpense
    print("You have this much left in your budget: ", monthTotal)

print('all done asshat, you have this much to spend this month: ', monthTotal)
